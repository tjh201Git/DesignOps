...
[samples, mcsi_values] = loadCSVSamples(filename);
samples = samples(1:35,:);
mcsi_values = mcsi_values(1:35);
...
[samples, mcsi_values] = loadCSVSamples(filename);
samples = samples(1:40,:);
mcsi_values = mcsi_values(1:40);
...
[samples, mcsi_values] = loadCSVSamples(filename);
samples = samples(1:49,:);
mcsi_values = mcsi_values(1:49);
